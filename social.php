...
<body style="margin:0;">
    ...
    <div id="myDiv" class="animate-bottom">
        ...
        <div class="container-fluid bg-light rounded">
            ...
            <h2 class="p-5 text-success">siga-nos no instagram</h2>

            <div class="row">

                <div class=" col-12">
                    <img class="img-100 rounded" src="imgs/insta.png" alt="">
                </div>


            </div>

            <a class="btn btn-orange text-center mb-5" target="_blank"
                href="https://www.instagram.com/proj_ecologico/">visitar</a>
