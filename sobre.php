...
<body style="margin:0;">
    ...
    <div id="myDiv" class="animate-bottom">
        ...
        <div class="container-fluid bg-light rounded">
            ...
            <h2 class="p-5 text-success">quem somos</h2>

            <div class="row">

                <div class=" col-12 pb-5">
                    <img class="img-100 rounded shadow " src="imgs/sobre-img.png" alt="">
                </div>
                
                <div class=" col-12 pb-5 pt-5 bt-success">
                    <div class="pt-5">
                        <p class="text-success">It is a long established fact that a reader will be distracted by the
                        readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it
                        has a more-or-less normal distribution of letters, as opposed to using here, content here',
